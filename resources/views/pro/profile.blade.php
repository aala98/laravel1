        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-white p-3 border-t-4 border-green-400">
                    ...
                    <h3 class="text-gray-600 font-lg text-semibold leading-6 text-center">Bio</h3>
                    <p class="text-sm text-gray-500 hover:text-gray-600 leading-6"> xxxxxxxxxxxxxxxxxxx</p>
                    <ul
